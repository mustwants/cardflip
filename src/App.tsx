...
export default function App() {
  return (
    <div style={{minHeight:"100svh",display:"grid",placeItems:"center",background:"#0a0d12",padding:24}}>
      <ProFlipCard
        width={420}
        height={560}
        name="Anne Leanos"
